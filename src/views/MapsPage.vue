  ...
  <div class="row row-cols-1 row-cols-md-4">
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 1 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 2 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 3 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-100">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 4 }}">Cartes</router-link>
      </div>
    </div> 
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 5 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 6 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 7 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 8 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 9 }}">Cartes</router-link>
      </div>
    </div>
    ...
    <div class="col mb-3">
      <div class="card h-80">
        ...
        <router-link class="btn btn-outline-secondary" :to="{ name: 'MapDetails', params: { id: 10 }}">Cartes</router-link>
      </div>
    </div>
